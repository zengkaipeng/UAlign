...
from pretrain_aug import AugDataset
...
def main_worker(worker_idx, args, tokenizer, log_dir, model_dir):
    ...
    train_moles, train_reacts = load_moles(args.data_path, 'train', verbose)
    test_moles, test_reacts = load_moles(args.data_path, 'val', verbose)
